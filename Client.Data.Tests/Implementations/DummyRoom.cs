...
{
    internal class DummyRoom(long id, float width, float height) : IRoom
    {
        ...
        public IHeater AddHeater(float x, float y, float temperature)
        {
            ...
            var heater = new DummyHeater(new Random().NextInt64(), x, y, temperature);
        ...
        public IHeatSensor AddHeatSensor(float x, float y)
        {
            ...
            var sensor = new DummyHeatSensor(new Random().NextInt64(), x, y);
